...
//         : _rule(std::make_unique<SqlInjectionRule>()) {}

//     bool detect_sql_injection(const std::string& data) {
...
int main() {
    ...
    // ruleLibrary.register_detector("sql", "sql");
    std::string httpRequestBody = "username=admin' union selece 1,2,3--+";
    ruleLibrary.detect_all(httpRequestBody);
}
// int main() {
//     SqlInjectionDetector detetor;
//     std::string httpRequestBody = "username=admin' union selece 1,2,3--+";
//     detetor.detect_sql_injection(httpRequestBody);
//     //  if (detetor.detect_sql_injection(httpRequestBody)) {
//     //     std::cout << "SQL Injection attack detected in the HTTP request body." << std::endl;
//     // }
//     // else {
//     //     std::cout << "No SQL Injection attack detected." << std::endl;
//     // }
//     return 0;
// }