...
public:
    DosAttackDetector() : _syn_flood_detector(std::make_unique<SynFloodDetector>()), _ack_flood_detector(std::make_unique<SynFloodDetector>()), _port_scan_detector(std::make_unique<SynFloodDetector>()) {}
